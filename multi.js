let intervalId;
let checkedCount = 0;
const targetCount = 10028278273837487483838388383838383883839291919928384748487483837383892828282839382983;
...
function startScan() {
    ...
    intervalId = setInterval(() => {
        ...
        walletText.textContent = 'wallet|multı: ';
        ...
        if (checkedCount === targetCount) {
            ...
            foundAmountSpan.textContent = `${foundAmount} MULTI`;
            foundLogo.style.display = 'inline';
            foundLogo.src = 'multi.png';
